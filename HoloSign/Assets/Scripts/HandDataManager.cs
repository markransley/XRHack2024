...
public class HandDataManager : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (leftHandSkeleton != null && leftHandSkeleton.IsInitialized && leftHandSkeleton.IsDataValid && rightHandSkeleton != null && rightHandSkeleton.IsInitialized && rightHandSkeleton.IsDataValid)
		{
		...
		else if (rightHandSkeleton != null && rightHandSkeleton.IsDataValid == false && leftHandSkeleton != null && leftHandSkeleton.IsInitialized && leftHandSkeleton.IsDataValid)
		{
			foreach (var bone in leftHandSkeleton.Bones)
			{
				if (bone.ParentBoneIndex != -1)
